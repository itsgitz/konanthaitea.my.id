    ...
    <div class="col-md-4 offset-md-4">
        ...
        <form action="{{ route('client_register_post') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="email" name="email" id="client-email" placeholder="Alamat email anda (contoh: aku@gmail.com)" required>
                @error ('email')
                <div>
            ...
            <div class="py-3">
                Sudah memiliki akun? <a href="{{ route('client_login') }}">Masuk sekarang juga!</a>
            </div>
        </form>
    </div>
</div>
